...
from solver_discrete import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ds_ratio', default = 8, type=int)
    ...
    parser.add_argument('--dataset', default='MSCOCO2K', choices={'MSCOCO2K', 'SPEECHCOCO', 'FLICKR'}, help='dataset name')
