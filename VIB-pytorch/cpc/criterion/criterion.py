...
class CPCUnsupervisedCriterion(BaseCriterion):
    ...
    def __init__(self,
        ...
        super(CPCUnsupervisedCriterion, self).__init__()
    ...
    def forward(self, cFeature, encodedData, label):
        ...
        :param label: LongTensor of size (batchSize,), speaker labels
        :returns: CPC loss and negative sample discrimination accuracy
        """
