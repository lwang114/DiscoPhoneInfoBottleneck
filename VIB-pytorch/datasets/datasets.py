...
from datasets.unsegmented_spoken_word_dataset import UnsegmentedSpokenWordDataset, UnsegmentedSpokenWordPreprocessor, collate_fn_unsegment_spoken_word
from datasets.unsegmented_librispeech import UnsegmentedLibriSpeechDataset, UnsegmentedLibriSpeechPreprocessor, collate_fn_librispeech
...
def return_data(args):
    ...
    if 'MNIST' in name :
      ...
      if args.get('train_segment', False):
        preprocessor = UnsegmentedLibriSpeechPreprocessor(
                         dset_dir, 80,
                         splits=args.splits,
                         audio_feature=args.audio_feature,
                         phone_label=args.phone_label,
                         ignore_index=args.ignore_index,
                         debug=args.debug)
        train_data = UnsegmentedLibriSpeechDataset(
                         dset_dir, 
                         preprocessor,
                         'train',
                         splits=args.splits, 
                         ...
                         phone_label=args.phone_label,
                         debug=args.debug) 
        test_data = UnsegmentedLibriSpeechDataset(
                         dset_dir, 
                         preprocessor,
                         'test',
                         splits=args.splits,
      ...
      if args.get('train_segment', False):
        preprocessor = UnsegmentedSpokenWordPreprocessor(
                         args.dataset, 
                         dset_dir, 80,
                         splits=args.splits,
                         audio_feature=args.audio_feature,
                         ...
                         use_blank=args.use_blank,
                         debug=args.debug)
        train_data = UnsegmentedSpokenWordDataset(
                         dset_dir,
                         preprocessor,
                         'train',
                         splits=args.splits,
                         ...
                         debug=args.debug)
        test_data = UnsegmentedSpokenWordDataset(
                         dset_dir,
                         preprocessor,
                         'test',
                         splits=args.splits,
                         ...
                         n_positives=args.n_positives,
                         debug=args.debug)
        collate_fn = collate_fn_unsegment_spoken_word
      else:
