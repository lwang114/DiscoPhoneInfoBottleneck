...
from solver_visual_multilingual_denoising_ib import Solver
from pyhocon import ConfigFactory
import sys
import os

def main(argv):
  parser = argparse.ArgumentParser(description='Visual multilingual information denoising bottleneck')
